...
{
	public final static String Salt = "xxx";
	private final static String appKey = "43b1d1922a90e680a1aba0f1";
	private final static String masterSecret = "10cb19065650afb8ea84b9bc";
	public final static String domain = "wukongbao.com";
	...
	public static void pushMessage(String username, String content,String type)
	{
		JPushClient jpushClient = new JPushClient(masterSecret, appKey, 3);
	        ...
	        PushPayload payload = buildPushObject_all_all_alert(username, content, type);
...
//			System.out.println("wkb result:"+result);
...
//			System.out.println("wkb response:"+sb);
			responseReader.close();
			conn.disconnect();
		}catch(Exception ex)
		{
