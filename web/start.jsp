...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $.get("runpush?flag=3", function (result) {
                if (result == "stop") {
                    var runstate = $("#runstate");
                    runstate.html("已关闭");
                    runstate.css("color", "black");
                }
                if (result == "start") {
                    var runstate = $("#runstate");
                    runstate.html("已开启");
                    runstate.css("color", "red");
                }
            });
...
<table>
    <tr>
        <td>断电推送</td>
        <td>
            <button id="elestart">开始推送</button>
        </td>
        <td>
            <button id="elestop">停止推送</button>
        </td>
        <td id="elestate">未开启0</td>
    </tr>
    <tr>
        <td>围栏推送</td>
        <td>
            <button id="fencestart">开始推送</button>
        </td>
        <td>
            <button id="fencestop">停止推送</button>
        </td>
        <td id="fencestate">未开启1</td>
    </tr>
    <tr>
        <td>震动推送</td>
        <td>
            <button id="shakestart">开始推送</button>
        </td>
        <td>
            <button id="shakestop">停止推送</button>
        </td>
        <td id="shakestate">未开启2</td>
    </tr>
    ...
    <tr>
        <td>防拆推送</td>
        <td>
            <button id="fangcstart">开始推送</button>
        </td>
        <td>
            <button id="fangcstop">停止推送</button>
        </td>
        <td id="fangcstate">未开启5</td>
    </tr>
    <tr>
        <td>充电推送</td>
        <td>
            <button id="chargestart">开始推送</button>
        </td>
        <td>
            <button id="chargestop">停止推送</button>
        </td>
        <td id="chargestate">未开启5</td>
    </tr>
    <tr>
        <td>低电推送</td>
        <td>
            <button id="lowstart">开始推送</button>
        </td>
        <td>
            <button id="lowstop">停止推送</button>
        </td>
        <td id="lowstate">未开启5</td>
    </tr>
    <tr>
        <td>SOS推送</td>
        <td>
            <button id="sosstart">开始推送</button>
        </td>
        <td>
            <button id="sosstop">停止推送</button>
        </td>
        <td id="sosstate">未开启5</td>
    </tr>
    <tr>
        <td>超速推送</td>
        <td>
            <button id="speedstart">开始推送</button>
        </td>
        <td>
            <button id="speedstop">停止推送</button>
        </td>
        <td id="speedstate">未开启5</td>
    </tr>
    <tr>
        <td>物联卡到期</td>
        <td>
            <button id="cardstart">开始推送</button>
        </td>
        <td>
            <button id="cardstop">停止推送</button>
        </td>
        <td id="cardstate">未开启5</td>
    </tr>
    <tr>
        <td>电门报警</td>
        <td>
            <button id="switchstart">开始推送</button>
        </td>
        <td>
            <button id="switchstop">停止推送</button>
        </td>
        <td id="switchstate">未开启5</td>
    </tr>
    <tr>
        <td>行驶提醒</td>
        <td>
            <button id="runstart">开始推送</button>
        </td>
        <td>
            <button id="runstop">停止推送</button>
        </td>
        <td id="runstate">未开启5</td>
    </tr>

    <tr>
        <td>其他推送</td>
        <td>
            <button id="otherstart">开始推送</button>
        </td>
        <td id="otherstate">状态</td>
    </tr>
</table>
<br>
<h3>牛丁推送</h3>
<table>
    <tr>
        <td>断电推送</td>
        <td>
            <button id="ndelestart">开始推送</button>
        </td>
        <td>
            <button id="ndelestop">停止推送</button>
        </td>
        <td id="ndelestate">未开启0</td>
    </tr>
    <tr>
        <td>围栏推送</td>
        <td>
            <button id="ndfencestart">开始推送</button>
        </td>
        <td>
            <button id="ndfencestop">停止推送</button>
        </td>
        <td id="ndfencestate">未开启1</td>
    </tr>
    <tr>
        <td>震动推送</td>
        <td>
            <button id="ndshakestart">开始推送</button>
        </td>
        <td>
            <button id="ndshakestop">停止推送</button>
        </td>
        <td id="ndshakestate">未开启2</td>
    </tr>
    ...
    <tr>
        <td>防拆推送</td>
        <td>
            <button id="ndfangcstart">开始推送</button>
        </td>
        <td>
            <button id="ndfangcstop">停止推送</button>
        </td>
        <td id="ndfangcstate">未开启5</td>
    </tr>
    <tr>
        <td>充电推送</td>
        <td>
            <button id="ndchargestart">开始推送</button>
        </td>
        <td>
            <button id="ndchargestop">停止推送</button>
        </td>
        <td id="ndchargestate">未开启5</td>
    </tr>
    <tr>
        <td>低电推送</td>
        <td>
            <button id="ndlowstart">开始推送</button>
        </td>
        <td>
            <button id="ndlowstop">停止推送</button>
        </td>
        <td id="ndlowstate">未开启5</td>
    </tr>
    <tr>
        <td>SOS推送</td>
        <td>
            <button id="ndsosstart">开始推送</button>
        </td>
        <td>
            <button id="ndsosstop">停止推送</button>
        </td>
        <td id="ndsosstate">未开启5</td>
    </tr>
    <tr>
        <td>超速推送</td>
        <td>
            <button id="ndspeedstart">开始推送</button>
        </td>
        <td>
            <button id="ndspeedstop">停止推送</button>
        </td>
        <td id="ndspeedstate">未开启5</td>
    </tr>
    <tr>
        <td>物联卡到期</td>
        <td>
            <button id="ndcardstart">开始推送</button>
        </td>
        <td>
            <button id="ndcardstop">停止推送</button>
        </td>
        <td id="ndcardstate">未开启5</td>
    </tr>
...
<table>
    <tr>
        <td>断电推送</td>
        <td>
            <button id="wkbelestart">开始推送</button>
        </td>
        <td>
            <button id="wkbelestop">停止推送</button>
        </td>
        <td id="wkbelestate">未开启0</td>
    </tr>
    <tr>
        <td>围栏推送</td>
        <td>
            <button id="wkbfencestart">开始推送</button>
        </td>
        <td>
            <button id="wkbfencestop">停止推送</button>
        </td>
        <td id="wkbfencestate">未开启1</td>
    </tr>
    <tr>
        <td>震动推送</td>
        <td>
            <button id="wkbshakestart">开始推送</button>
        </td>
        <td>
            <button id="wkbshakestop">停止推送</button>
        </td>
        <td id="wkbshakestate">未开启2</td>
    </tr>
    ...
    <tr>
        <td>防拆推送</td>
        <td>
            <button id="wkbfangcstart">开始推送</button>
        </td>
        <td>
            <button id="wkbfangcstop">停止推送</button>
        </td>
        <td id="wkbfangcstate">未开启5</td>
    </tr>
    <tr>
        <td>充电推送</td>
        <td>
            <button id="wkbchargestart">开始推送</button>
        </td>
        <td>
            <button id="wkbchargestop">停止推送</button>
        </td>
        <td id="wkbchargestate">未开启5</td>
    </tr>
    <tr>
        <td>低电推送</td>
        <td>
            <button id="wkblowstart">开始推送</button>
        </td>
        <td>
            <button id="wkblowstop">停止推送</button>
        </td>
        <td id="wkblowstate">未开启5</td>
    </tr>
    <tr>
        <td>SOS推送</td>
        <td>
            <button id="wkbsosstart">开始推送</button>
        </td>
        <td>
            <button id="wkbsosstop">停止推送</button>
        </td>
        <td id="wkbsosstate">未开启5</td>
    </tr>
    <tr>
        <td>超速推送</td>
        <td>
            <button id="wkbspeedstart">开始推送</button>
        </td>
        <td>
            <button id="wkbspeedstop">停止推送</button>
        </td>
        <td id="wkbspeedstate">未开启5</td>
    </tr>
    <tr>
        <td>物联卡到期</td>
        <td>
            <button id="wkbcardstart">开始推送</button>
        </td>
        <td>
            <button id="wkbcardstop">停止推送</button>
        </td>
        <td id="wkbcardstate">未开启5</td>
    </tr>
</table>
<script type="text/javascript">
...
//			alert("start");
    ...
    $("#runstop").click(function () {
        $.get("runpush?flag=2", function (result) {
            var ele = $("#runstate");
            ele.html("已关闭");
            ele.css("color", "black");
        });
