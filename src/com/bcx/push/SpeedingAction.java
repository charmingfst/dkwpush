...
import com.bcx.push.task.SosTask;
import com.bcx.push.task.SpeedingTask;
import com.opensymphony.xwork2.ActionSupport;

public class SpeedingAction extends ActionSupport
{
	private int flag;
	...
	public String execute() throws Exception
	{
		...
		if (flag == 0)
		{
					...
					|| (scheduler != null && !scheduler.isStarted()))
			{
				...
				props.put("org.quartz.scheduler.instanceName", "bcxspeeding");
				...
				Class<? extends Job> clazz = SpeedingTask.class;
				String runtime = "0/10 * * * * ?";
