...
import com.pet.push.task.ExpireAlarmTask;


public class ExpireAction extends ActionSupport
{
	private int flag;
	...
	public String execute() throws Exception
	{
		if (flag == 0)
		{
					...
					|| (scheduler != null && !scheduler.isStarted()))
			{
				...
				props.put("org.quartz.scheduler.instanceName", "petexpire");
				props.put("org.quartz.threadPool.threadCount", "5"); // 必填
				sf.initialize(props);
				scheduler = sf.getScheduler();

				Class<? extends Job> clazz = ExpireAlarmTask.class;
