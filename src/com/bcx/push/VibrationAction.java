...
import com.bcx.push.task.FenceAlarmTask;
import com.bcx.push.task.VibrationAlarmTask;
import com.opensymphony.xwork2.ActionSupport;

public class VibrationAction extends ActionSupport
{
	private int flag;
	...
	public String execute() throws Exception
	{
		...
		if (flag == 1)
		{
					...
					|| (scheduler != null && !scheduler.isStarted()))
			{
				...
				props.put("org.quartz.scheduler.instanceName", "bcxshake");
				...
				Class<? extends Job> clazz = VibrationAlarmTask.class;
				String runtime = "0/10 * * * * ?";
