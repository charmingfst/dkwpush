...
import com.pet.push.task.LowPowerTask;

public class LowPowerAction extends ActionSupport
{
	private int flag;
	...
	public String execute() throws Exception
	{
		...
		if (flag == 0)
		{
					...
					|| (scheduler != null && !scheduler.isStarted()))
			{
				...
				props.put("org.quartz.scheduler.instanceName", "petlowpower");
				...
				Class<? extends Job> clazz = LowPowerTask.class;
				String runtime = "0/10 * * * * ?";
